...
namespace BikeDistributor.Domain
{
    public class OrderTest
    {
        ...
        private static readonly string ResultStatementOneDefy = new StringBuilder($"Order Receipt for Anywhere Bike Shop{Environment.NewLine}\t1 x Giant Defy 1 = $1,000.00{Environment.NewLine}Sub-Total: $1,000.00{Environment.NewLine}Tax: $72.50{Environment.NewLine}Total: $1,072.50").ToString();
        ...
        private static readonly string ResultStatementOneElite = new StringBuilder($"Order Receipt for Anywhere Bike Shop{Environment.NewLine}\t1 x Specialized Venge Elite = $2,000.00{Environment.NewLine}Sub-Total: $2,000.00{Environment.NewLine}Tax: $145.00{Environment.NewLine}Total: $2,145.00").ToString();
        ...
        private static readonly string ResultStatementOneDuraAce = new StringBuilder($"Order Receipt for Anywhere Bike Shop{Environment.NewLine}\t1 x Specialized S-Works Venge Dura-Ace = $5,000.00{Environment.NewLine}Sub-Total: $5,000.00{Environment.NewLine}Tax: $362.50{Environment.NewLine}Total: $5,362.50").ToString();
